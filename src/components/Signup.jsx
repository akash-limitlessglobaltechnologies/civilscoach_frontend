...
const Signup = () => {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
        <div className="flex flex-col lg:flex-row min-h-screen">
          {/* Left Side - Signup Form (Mobile: Full width, Desktop: 30%) */}
  ...
  if (step === 2) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
        <div className="flex flex-col lg:flex-row min-h-screen">
          {/* Left Side - OTP Form (Mobile: Full width, Desktop: 30%) */}
          <div className="w-full lg:w-[30%] flex items-center justify-center px-4 sm:px-6 py-8 lg:py-12 order-2 lg:order-1">
            <div className="w-full max-w-md space-y-4 lg:space-y-6">
              {/* Header */}
              <div className="text-center">
                    ...
                    <label className="block text-sm font-medium text-gray-700 mb-1">
                      <div className="flex items-center gap-2">
                        ...
                        {otpStatus.emailVerified && (
                          <span className="ml-2 text-green-600 font-medium text-xs">✓ Verified</span>
                        )}
                      </div>
                    </label>
                    <input
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex space-x-2">
                      <button
                        ...
                        className="flex-1 bg-gray-100 text-gray-700 py-2 px-3 rounded-lg text-xs font-medium hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-500 disabled:opacity-50 transition-all"
                      >
              ...
              <div className="text-center text-xs text-gray-600">
                <p>Secure verification with email and SMS</p>
              </div>
            </div>
          </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      <div className="flex flex-col lg:flex-row min-h-screen">
        {/* Left Side - Profile Form (Mobile: Full width, Desktop: 30%) */}
        <div className="w-full lg:w-[30%] flex items-center justify-center px-4 sm:px-6 py-8 lg:py-12 order-2 lg:order-1">
          <div className="w-full max-w-md space-y-4 lg:space-y-6">
            {/* Header */}
            <div className="text-center">
